<div id="page-<? the_ID() ?>" class="page container">
	...
	<?php endif; ?>
	<?php $temp_post = $post; $subpages = get_pages(array('parent' => get_the_ID(), 'hierarchical' => 0, 'sort_column' => 'menu_order', 'sort_order' => 'ASC', 'meta_key' => '_wp_page_template', 'meta_value' => get_template_file('carousel'))); ?>
