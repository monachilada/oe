		...
		<div class="container">
			<div class="row">
				<div class="col span12 push6">
					...
					<?php endif; ?>
					<?php if ( is_day() ) : ?>
						<h2 class="text-center">Archive: <?php echo  get_the_date( 'D M Y' ); ?></h2>							
					<?php elseif ( is_month() ) : ?>
						<h2 class="text-center">Archive: <?php echo  get_the_date( 'M Y' ); ?></h2>	
					<?php elseif ( is_year() ) : ?>
						<h2 class="text-center">Archive: <?php echo  get_the_date( 'Y' ); ?></h2>								
					<?php else : ?>
